// src/pages/admin-dashboard/inventory-management.js
import React from "react"
import * as styles from './inventory-management.module.css'; // 确保CSS模块文件的路径正确
      ...
      <AdminLayout>
        <Breadcrumbs
          crumbs={[
            ...
            { link: '/admin-dashboard/inventory-management/', label: 'Inventory Management' },
          ]}
        />
        {/*<h1>Orders</h1>*/}
